...
<template>
  <!-- Hero Section -->
  <section
    class="flex items-center justify-between h-screen pt-[10vh] gap-4 bg-gradient-to-t from-white dark:from-black to-blue-500 dark:to-blue-800"
  >
      ...
      <template #item="{ item }">
        <div class="flex justify-between items-center gap-6 mt-8">
          <div class="w-[40%]">
            ...
            <div
              class="py-4 rounded-r-full flex flex-col space-y-2 bg-gradient-to-r from-white dark:from-black to-blue-500 dark:to-blue-800"
            >
  ...
  <section>
    ...
    <div class="flex items-center justify-between max-w-xl mx-auto mt-4">
      ...
      >
        <Icon name="material-symbols-light:linked-services" class="text-4xl" />
      </div>
    </div>
